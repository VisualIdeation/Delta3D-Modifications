...
Application::Application(const std::string& configFilename, dtCore::DeltaWin* win)
   ...
   , mMouseListener(new dtCore::GenericMouseListener()), enableVRToolKit(false)
{
...
/**
 * Description: Application - Additional Constructor.
 *
 * @param _enableVRToolKit - bool integrate with VR ToolKit
 * @param configFilename - const std::string& name of configuration file
 * @param win - dtCore::DeltaWin* the DeltaWin
 * Created
 * Author: Patrick O'Leary
...
Application::Application(bool _enableVRToolKit, const std::string& configFilename, dtCore::DeltaWin* win)
   ...
   , mThreadPoolInitialized(false)
   , mKeyboardListener(new dtCore::GenericKeyboardListener())
   , mMouseListener(new dtCore::GenericMouseListener()), enableVRToolKit(_enableVRToolKit)
{
   RegisterInstance(this);
